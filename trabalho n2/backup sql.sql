...
-- Dump completed on 2024-12-03 22:05:51
CREATE DATABASE  IF NOT EXISTS `formulario-joao` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `formulario-joao`;
-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: formulario-joao
-- ------------------------------------------------------
-- Server version	5.5.5-10.4.32-MariaDB
...
INSERT INTO `usuarios` VALUES (1,'Gustavo','patricia.passos@outlook.com.br','654321','2000-04-04','masculino','mensal','rua de la','foda'),(2,'Gustavo','patricia.passos@outlook.com.br','654321','2000-04-04','masculino','mensal','rua de la','foda'),(3,'joao vitor','glaucia.de3@terra.com.br','565664','7000-07-11','outro','trimestral','rua de ca','fida'),(4,'ana','ana@gmail.com','(11) 95555-5555','2000-10-11','feminino','anual','rua das','nenhum.'),(5,'ana','ana@gmail.com','(11) 95555-5555','2000-10-11','feminino','anual','rua das','nenhum.'),(6,'anne','ponapif698@devncie.com','(11) 95555-5554','2000-10-11','feminino','semestral','rua das pois','algum.');
...
-- Dump completed on 2024-12-03 22:05:52
...
INSERT INTO `pma__recent` VALUES ('root','[{\"db\":\"formulario-joao\",\"table\":\"usuarios\"},{\"db\":\"fam\\u00edlia\",\"table\":\"pessoas\"}]');
...
INSERT INTO `pma__userconfig` VALUES ('root','2024-12-03 21:54:53','{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
